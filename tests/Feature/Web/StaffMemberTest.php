...
class StaffMemberTest extends TestCase
{
    ...
    public function test_vendor_cant_delete_staff_member_it_doesnt_belong_to_shop(): void
    {
        $vendor = $this->getVendorUser();
        ...
        $anotherStaffMember = $anotherVendor->shop->staff()->first();
