        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            ...
            <div v-if="$page.props.auth.user" class="hidden sm:flex sm:items-center sm:ml-6">
              ...
              >
                Корзина {{ ($page.props.cart.total / 100).toFixed(2) }} &#8381;
              </Link>
              <!-- Settings Dropdown -->
            ...
            <div v-else class="hidden sm:flex gap-4 items-center sm:ml-6">
              <Link :href="route('login')" class="btn btn-secondary">Войти</Link>
              <Link :href="route('register')" class="btn btn-primary">Зарегистрироваться</Link>
            </div>
